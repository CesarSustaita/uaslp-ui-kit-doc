...
<div class="components-structure">
    <div class="responsive-structure-full"> 
        <img src="/public/img/Dialog-Body.svg" alt="IMG - Vista previa del componente Dialog" />
    </div>
</div>
...
<div class="components-structure">
    ...
    <div class="responsive-structure"> 
        <img src="/public/img/Dialog-Body-mobile.svg" alt="IMG - Vista previa del componente Dialog" />
    </div>
</div>
